...
?>
<div data-wow-delay="<?php echo esc_attr($css_animation_delay); ?>" class="cms-fancyboxes-wraper cms_fancybox_layout4 default-color <?php echo esc_attr($atts['template']);?> <?php echo esc_attr($animate_class); ?> clearfix" id="<?php echo esc_attr($atts['html_id']);?>">
